...
| API 또는 라이브러리 | Google : Chart<br>Kakao : Login, Map<br>Naver : Login, SENS(SMS)<br>tawk |
...
특히 우리 모두가 각자 설계자면서 프론트엔드, 백엔드 그 외 프로젝트에 해당하는 모든 것을 다 담당해야 했는데, 그러다 보니 셋이서 생각하는 방향이 다를 때도 많았습니다.🤦 비록 다 엎어버린 설계들이었지만 지금 돌이켜 생각해 보면, 그 기간 동안 초보 개발자들이 할 수 있는 잘못된 생각과 착각들을 고쳐 잡을 수 있었던 중요한 시간이었던 것 같아요. '진짜 🌟설계가 엄청나게 중요🌟한 것이구나..'하는 생각이 프로젝트를 마무리하고서도 머리에 박혀있네요.<br><br>

아무튼 이런 앞의 과정을 거치면서 저희의 실력과 현주소를 깨닫고, 바닥에서부터 쌓아 올려서 매일 배워나가며 작업한다는 생각으로 프로젝트를 시작했습니다. 마지막으로 설계를 다시 시작할 때 셋이서 우스갯소리로 '정말 흰 화면에 검정 글씨만 나와도 된다..! 기능만이라도 제대로 구현하자..!'는 이야기를 했었는데, 각자가 맡은 부분에서 다들 100% 이상의 효율을 보여주었기 때문에 점점 더 기능이 추가되면서 지금의 🥳만나맛나가 탄생🎉되었습니다.<br><br>

정말 마지막 설계를 할 때만 해도 이 정도로 기능 구현이 많이 추가될 거라 생각하지 못했는데, 끝나는 날까지 쥐어짜내서 프로젝트에 임해주신 팀원들께 감사드려요.👍<br><br>

저는 평소 어떤 일이든, 회사든 '본인의 능력, 소통과 공감 능력이 뛰어난 리더'와 그 '리더에 대한 신뢰를 가지고 다 같이 열심히 하는 구성원들'이 한 팀이 된다면 그 팀은 정말 뭘 해도 잘할 수 있다고 생각합니다. 그런 관점에서 저희 팀을 돌아봤을 때 셋 다 실력이 고만고만하다 보니, 제가 실력이 그렇게 뛰어난 리더도 아니었고 소통과 공감 능력도 그렇게 뛰어난 편이 아니었던 것 같아요.🤔 제가 조금 더 능력이 있었더라면, 더 많은 도움을 드리고 같이 소통하면서 해결책을 찾아볼 수 있었을 텐데.. 그 정도 수준이 되기에는 제가 아직 너무나 부족하다는 생각을 많이 했습니다. (앞으로 더 성장해야겠죠?💪) 그래서 훌륭한 두 구성원들의 잠재되어 있는 능력치를 이끌어주지 못했다는 게 조금 아쉬움으로 남습니다. 제가 지금 당장 너무 부족해서 저의 능력치만 이끌어내기에 조급했던 게 아닌가 하는 생각이 들어요.🙇
...
다들 수고 많으셨습니다.<br>
아무것도 모르는 백지 상태에서 맨땅에 해딩하기라 시작은 매우 막막했었어요.<br>
설계단계에서는 최소기능도 구현할 수 있을까 하는 막연한 생각이 들었지만 주변 사람들의 도움 받아가며 시행과 착오를 겪어가다보니 개개인의 실력이 늘어갔고 <br>
결국엔 2차, 3차 기능으로 설계했던 부분까지 추가적으로 구현 가능해졌다는게 정말 신기했습니다.<br>
팀 프로젝트란게 처음이었던 저에게는 개인의 발전도 중요했지만 무엇보다도 프로젝트에 있어서 초반 설계와 팀원간의 소통이 중요하단 사실을 깨닫게 해주는 유익한 시간이었습니다.<br>
초반에 여러 과정 거쳐가며 스트레스 받는 순간들도 분명 있었을텐데 멘탈 지켜가며 프로젝트를 성공적인 방향으로 마무리 할 수 있게 이끌어주신 조장님,<br>
모르는게 있어서 질문할 때 마다 같이 고민해주며 서포트해주신 재환님께 감사하다는 말씀 드립니다.<br>
다시 한번 모두들 수고 많으셨고, 각자의 개발자 라이프에서 좋은 일들만 가득하기를⭐
...
조장님이 말씀하셨던 것 처럼, 넘치는 열정과 에너지로 다른 조에 비해서 비교적 일찍 프로젝트 설계를 시작 했습니다만..😭설계를 잘 차려놓는 것이 정말 어려운 일이라는 것을 알았습니다..!의견을 합치며 엎치락 뒤치락 했었던 탓에, 설계과정에서 이미 다들 지치고 힘들었던 것 같습니다..그럼에도 불구하고 각자 맡은 바 끝까지 포기하지 않고 해낸 저희 1조 혼밥탈출 넘버원 팀원 모두 감사드리고 또 감사드립니다!!!!!!🤗설계시 쏟아지는 아이디어를 하나의 둥근 형태로 가공하는 과정에서 저는 소통, 정리능력을 배웠고, 역할분배 후 코드작업을 하는 과정에서는 책임감 및 CS, 다른 팀원들의 어려움을 듣고 서로 해결해주면서 소통과, 협업을 배울 수 있었습니다. 이 경험을 항상 새겨두고 팀원들을 위하는 발전하는 개발자로 성장해 나가겠습니다!!! 이 때까지 모두 정말 수고 많으셨습니다!!!😊앞으로는 혼밥하지 말자구요!!!!!(종종 같이 밥먹어요ㅎㅎ)😁😁
</details>
